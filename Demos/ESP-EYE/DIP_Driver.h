...
typedef struct {
    ...
    // Filtering Image in Spatial Domain
         ...
         */
        void (*filter2D)(const Image *inImg, Image *outImg, int size, const float *filter);
         ...
         */
        void (*filter2Dsep)(const Image *inImg, Image *outImg, int kernelSizeX, float *kernelX,
    ...
    // Filtering in Frequency Domain
         ...
         */
        void (*fourier)(Image *inImg, Image *outImg, int FFT_SIZE);
         ...
         */
        void (*abs)(Image *inImg, Image *outImg, int FFT_SIZE, int quadrant_change);
         ...
         */
        void (*fourierInv)(Image *inImg, Image *outImg, int FFT_SIZE);
    ...
    // Geometrical Transformations
         ...
         * @sa Image
         */
        void (*perspectiveTransform)(const Image *inImg, Image *outImg, float h[3][3]);
